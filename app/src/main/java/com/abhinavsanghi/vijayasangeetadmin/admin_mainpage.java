...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_pass_reset) {
            ...
            //startActivity(new Intent(getApplicationContext(),view_student_inadmin_mid.class));
            Intent intent=new Intent(getApplicationContext(),view_student_inadmin_mid.class);
            intent.putExtra("tid",tid);
            startActivity(intent);
