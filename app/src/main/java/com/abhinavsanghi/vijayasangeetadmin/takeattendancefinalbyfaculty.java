...
public class takeattendancefinalbyfaculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stdSubdetail=FirebaseDatabase.getInstance().getReference("Batchdetails");
        ...
        if (count1==count2)
        {
            ...
            builder.setPositiveButton("Edit", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent3=new Intent(getApplicationContext(),edit_attendance_bydate.class);
                    intent3.putExtra("subid",subid);
                    intent3.putExtra("date",timestamp);
